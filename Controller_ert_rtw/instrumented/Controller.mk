...
MODEL                   = Controller
MODULES                 = Controller.c ert_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
...
MASTER_ANCHOR_DIR       = 
START_DIR               = D:\ITAE~1\AE-CUS~1\CONTRO~1\Models\ROBOTA~1\work
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
BUILDARGS               =  GENERATE_ERT_S_FUNCTION=0 GENERATE_ASAP2=0 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
...
{$(START_DIR)\Controller_ert_rtw}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
...
{$(START_DIR)\Controller_ert_rtw}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<
